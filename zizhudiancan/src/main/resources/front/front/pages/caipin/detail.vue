		...
		<view class="container">
			...
			<view class="detail-content">
				<view class="price detail-list-item priceFavor"
					...
					<view class="name shop-title"
                          :style='{"boxShadow":"0 1rpx 0 rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"#fff","backgroundColor":"#fff","color":"#06A9FF","borderRadius":"0","borderWidth":"0","fontSize":"36rpx","borderStyle":"solid"}'>
                        评分：<uni-rate style="float: right;margin-right: 39%;" allow-half readonly :value="totalScore"/>
	...
	export default {
		...
		async onShow(options) {
            ...
            let data = {
                ...
                average: 'caipin_commentback_pingfen_number',
                condition1: 'caipin_id',
                condition1Value: this.id,
            }
