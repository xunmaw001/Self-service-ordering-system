            ...
            <uni-popup class="popup-content" ref="popup" type="center">
                <form class="popup-form">
                    <view class="uni-flex uni-column" style="background-color: #FFFFFF;border-radius: 10rpx;width: 500rpx;height: auto;">
                        ...
                        评分：<uni-rate style="margin-left: 70rpx;" :value="caipinCommentbackPingfenNumber" @change="pingfen" />
                ...
                <form class="popup-form">
                    <view class="uni-flex uni-column"
                        ...
                        <view class="flex-item flex-item-V" style="margin: 0 10rpx 0 10rpx;">
                            快递公司：
                            <input :style='{"boxShadow":"0 0 16rpx #3A78F1 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#06A9FF","borderRadius":"20rpx","color":"#06A9FF","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                   v-model="caipinOrderCourierName" placeholder="配送员名称"></input>
                        </view>
                        <view class="flex-item flex-item-V" style="margin: 0 10rpx 0 10rpx;">
                            快递单号：
                            <input :style='{"boxShadow":"0 0 16rpx #3A78F1 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#06A9FF","borderRadius":"20rpx","color":"#06A9FF","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
        ...
        methods: {
            ...
            async deliver(order) {
                ...
                if(_this.caipinOrderCourierName == null || _this.caipinOrderCourierName == "" || _this.caipinOrderCourierName == "null"){
                    return _this.$utils.msg('配送员名称不能为空');
                }
            ...
            pingfen(e){
                this.caipinCommentbackPingfenNumber = e.value
            },
            //评价内容
            async onFinishTap() {
                let _this = this
				...
				if (_this.caipinCommentbackPingfenNumber <= 0 ) {
                    _this.$utils.msg('请评分');
                    return
                }
                let data = [
                  ...
                  ,{
                        key:'caipinCommentbackPingfenNumber',
                        val:_this.caipinCommentbackPingfenNumber,
                    }
                ]
