<template>
	<view class="content">
		 ...
		 <view
				 ...
				 v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#06A9FF","textAlign":"left"}'>用户手机号
			 </view>
			 <input style="padding: 0 30upx"
					:style='{"boxShadow":"0 0 16rpx #3A78F1 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#06A9FF","borderRadius":"20rpx","color":"#06A9FF","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
		 ...
		 <view
				 ...
				 v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#06A9FF","textAlign":"left"}'>用户身份证号
			 </view>
			 <input style="padding: 0 30upx"
					:style='{"boxShadow":"0 0 16rpx #3A78F1 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#06A9FF","borderRadius":"20rpx","color":"#06A9FF","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
			...
			<view
				...
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"#06A9FF","textAlign":"left"}'>用户头像
				</view>
				<image
			...
			<view v-if="tableName=='yonghu'"
				...
				<picker @change="yonghusexTypesChange" :value="sexTypesIndex" :range="sexTypesOptions" range-key="indexName">
					<view style="padding: 0 30upx" :style='{"boxShadow":"0 0 16rpx #3A78F1 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#06A9FF","borderRadius":"20rpx","color":"#06A9FF","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
		 ...
		 <view
				 ...
				 v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#06A9FF","textAlign":"left"}'>电子邮箱
			 </view>
			 <input style="padding: 0 30upx"
					:style='{"boxShadow":"0 0 16rpx #3A78F1 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#06A9FF","borderRadius":"20rpx","color":"#06A9FF","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
